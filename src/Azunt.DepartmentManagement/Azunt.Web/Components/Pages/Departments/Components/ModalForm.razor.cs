...
namespace Azunt.Web.Pages.Departments.Components;
...
public partial class ModalForm : ComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public Department ModelSender { get; set; } = null!; // null이 아닌 Department으로 초기화

    public Department ModelEdit { get; set; } = null!; // null이 아닌 Department으로 초기화
