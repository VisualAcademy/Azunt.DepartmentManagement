...
using Azunt.Web.Pages.Departments.Components;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Authorization;
using Microsoft.AspNetCore.Identity;
using Microsoft.JSInterop;

namespace Azunt.Web.Components.Pages.Departments;

public partial class DepartmentManager : ComponentBase
{
    ...
    [Inject]
    public IDepartmentRepository RepositoryReference { get; set; } = null!;

    [Inject]
    public IConfiguration Configuration { get; set; } = null!;

    [Inject]
    public DepartmentDbContextFactory DbContextFactory { get; set; } = null!;
    #endregion
    ...
    /// </summary>
    protected List<Department> models = new List<Department>();

    /// <summary>
    /// 현재 페이지에서 선택된 단일 데이터를 나타내는 모델 클래스 
    /// </summary>
    protected Department model = new Department();
    ...
    protected void ShowEditorForm()
    {
        ...
        this.model = new Department(); // 모델 초기화
    ...
    /// </summary>
    protected void EditBy(Department model)
    {
    ...
    /// </summary>
    protected void DeleteBy(Department model)
    {
        this.model = model;
    ...
    protected async void DeleteClickOld()
    {
        ...
        this.model = new Department(); // 선택했던 모델 초기화
    ...
    protected async void ToggleClickOld()
    {
        ...
        this.model = new Department(); // 선택한 모델 초기화 
    ...
    /// ToggleBy(PinnedBy)
    /// </summary>
    protected void ToggleBy(Department model)
    {
        this.model = model;
